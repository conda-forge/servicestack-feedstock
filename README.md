...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/servicestack-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=13482&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/servicestack-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `servicestack` can be installed with:

```
conda install servicestack
```

It is possible to list all of the versions of `servicestack` available on your platform with:
